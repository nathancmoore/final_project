# Generated by Django 2.0 on 2017-12-19 21:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_format', multiselectfield.db.fields.MultiSelectField(choices=[('BB', 'Big Book Study'), ('C', 'Closed meeting for those with a desire to stop using cocaine and all other substances. Newcomers welcome.'), ('CL', 'Candle Light'), ('LS', 'Literature Study'), ('M', 'Men only'), ('NC', 'No children please.'), ('SB', 'Meeting has a smoke break.'), ('W', 'Women only.'), ('HC', 'Wheelchair accessible')], max_length=200)),
